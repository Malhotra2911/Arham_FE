...
const Prospectus = () => {
  ...
  const datas = [
    {
      link: "/assets/prospectus/Draft Prospectus.pdf",
      image: pdf,
      name: "Draft Prospectus"
    },
    {
      link: "/assets/prospectus/Final Prospectus.pdf",
      image: pdf,
      name: "Final Prospectus"
    },
    {
      link: "/assets/prospectus/General Information Document.pdf",
      image: pdf,
      name: "General Information Document"
    },
    {
      link: "/assets/prospectus/Abridged Prospectus.pdf",
      image: pdf,
      name: "Abridged Prospectus"
    },
    {
      link: "/assets/prospectus/Pre Issue Advertisement.pdf",
      image: pdf,
      name: "Pre Issue Advertisement"
    },
  ]
  ...
  return (
    <div>
      <section className='prospectusPart1'>
        <h1 style={{textAlign: "left", marginTop: "20vh"}}><strong>Prospectus</strong></h1>
      </section>

      <section className='container prospectusPart2'>
        <div className='row mx-2 my-4 content'>
          <div className='col-md-12 col-lg-4 prospectusPart2_1 p-3 d-none d-md-block'>
          ...
          <div className='col-md-12 col-lg-8 scrollableContent' align='center'>
            <h1><strong>Prospectus</strong></h1>
            <div className="container-fluid p-3">
                <form className="d-flex" role="search">
                <input className="form-control me-2" type="search" placeholder="Search Prospectus" aria-label="Search" value={searchQuery} onChange={handleSearchChange} />
            ...
            <h1><strong>IPO Forms NSE India</strong></h1>
          </div>
        </div>
      </section>
    </div>
