...
const ShareWarrants = () => {
    ...
    {
      link: "/assets/shareWarrants/Revised PCS Compliance Certificate.pdf",
      image: pdf,
      name: "Revised PCS Compliance Certificate"
    },
    {
      link: "/assets/shareWarrants/Revised PCS Pricing Certificate.pdf",
      image: pdf,
      name: "Revised PCS Pricing Certificate"
    },
    {
      link: "/assets/shareWarrants/PCS_Certificate.pdf",
      image: pdf,
  ...
  const valuationReportData = [
    {
      link: "/assets/shareWarrants/Valuation_Report.pdf",
      image: pdf,
      name: "Valuation Report"
    },
    {
      link: "/assets/shareWarrants/Revised Valuation Report.pdf",
      image: pdf,
  ...
  const corrigendumAuraData = [
    {
      link: "/assets/shareWarrants/Corrigendum_Notice.pdf",
      image: pdf,
  ...
  return (
    <div>
      <section className='shareWarrantsPart1'>
        <h1 style={{textAlign: "left", marginTop: "20vh"}}><strong>Share Warrants</strong></h1>
      </section>

      <section className='container shareWarrantsPart2'>
        <div className='row mx-2 my-4 content'>
          <div className='col-md-12 col-lg-4 shareWarrantsPart2_1 p-3 d-none d-md-block'>
          ...
          <div className='col-md-12 col-lg-8 scrollableContent' align='center'>
            <h1><strong>Share Warrants</strong></h1>
            <div className="container-fluid p-3">
                <form className="d-flex" role="search">
                <input className="form-control me-2" type="search" placeholder="Search Share Warrants" aria-label="Search" value={searchQuery} onChange={handleSearchChange} />
