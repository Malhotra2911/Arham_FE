...
import '../css/InvestorPresentation.css'
...
const InvestorPresentation = () => {
    ...
    const datas = [
        {
          name: "Arham Technologies Investor Presentation - H1FY26",
          issue: "",
          image: pdf,
          link: "/assets/investorPresentation/Arham Technologies Investor Presentation- H1FY26.pdf",
        }
      ]
  ...
  return (
    <div>
        ...
        <h1 style={{textAlign: "left", marginTop: "20vh"}}><strong>Investor Presentation</strong></h1>
        </section>

        <section className='container investorPresentationPart2'>
        <div className='row mx-2 my-4 content'>
            <div className='col-md-12 col-lg-4 investorPresentationPart2_1 p-3 d-none d-md-block'>
            ...
            <h1><strong>Investor Presentation</strong></h1>
            <div className="container-fluid p-3">
                <form className="d-flex" role="search">
                <input className="form-control me-2" type="search" placeholder="Search Investor Presentation" aria-label="Search" value={searchQuery} onChange={handleSearchChange} />
