...
import '../css/IntimationToTheStockExchange.css'
import pdf from '../assets/pdf.png'

const IntimationToTheStockExchange = () => {

  const datas = [
    {
      link: "/assets/intimationToTheStockExchange/Intimation to the Stock Exhange -Notice of EGM.pdf",
      image: pdf,
      name: "EGM Notice"
    }
  ]
  ...
  return (
    <div>
      <section className='intimationToTheStockExchangePart1'>
        <h1 style={{textAlign: "left", marginTop: "20vh"}}><strong>Intimation To The Stock Exchange</strong></h1>
      </section>

      <section className='container intimationToTheStockExchangePart2'>
        <div className='row mx-2 my-4 content'>
          <div className='col-md-12 col-lg-4 intimationToTheStockExchangePart2_1 p-3 d-none d-md-block'>
          ...
          <div className='col-md-12 col-lg-8 scrollableContent' align='center'>
            <h1><strong>Intimation To The Stock Exchange</strong></h1>
            <div className="container-fluid p-3">
                <form className="d-flex" role="search">
                <input className="form-control me-2" type="search" placeholder="Search Intimation To The Stock Exchange" aria-label="Search" value={searchQuery} onChange={handleSearchChange} />
                {/* <button className="btn btn-outline-danger" type="submit">Search</button> */}
                </form>
            </div>
            <h2 className='mt-2 p-1'><strong>General Meeting</strong></h2>
...
export default IntimationToTheStockExchange
