...
const PressRelease = () => {
    ...
    const datas = [
        {
          name: "Arham Technologies H1FY26 Results Press Release",
          issue: "",
          image: pdf,
          link: "/assets/pressRelease/Arham Technologies H1FY26 Results Press Release.pdf",
        }
      ]
  ...
  return (
    <div>
      <section className='pressReleasePart1'>
        <h1 style={{textAlign: "left", marginTop: "20vh"}}><strong>Press Release</strong></h1>
      </section>

      <section className='container pressReleasePart2'>
        <div className='row mx-2 my-4 content'>
          <div className='col-md-12 col-lg-4 pressReleasePart2_1 p-3 d-none d-md-block'>
          ...
          <div className='col-md-12 col-lg-8 scrollableContent' align='center'>
            ...
            <div className="container-fluid p-3">
                ...
                <input className="form-control me-2" type="search" placeholder="Search Press Release" aria-label="Search" value={searchQuery} onChange={handleSearchChange} />
